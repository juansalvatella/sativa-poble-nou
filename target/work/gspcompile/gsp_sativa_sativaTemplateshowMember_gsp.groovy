...
printHtmlPart(19)
for( _it1913689365 in (1..yellowCard) ) {
changeItVariable(_it1913689365)
printHtmlPart(20)
...
printHtmlPart(45)
for( _it514576436 in (listCustomEvents) ) {
changeItVariable(_it514576436)
printHtmlPart(46)
...
printHtmlPart(53)
for( _it569513383 in (listGenetics) ) {
changeItVariable(_it569513383)
printHtmlPart(54)
...
printHtmlPart(66)
for( _it476813402 in (listEvents) ) {
changeItVariable(_it476813402)
printHtmlPart(67)
expressionOut.print(it.writer)
printHtmlPart(47)
...
public static final long LAST_MODIFIED = 1491500026123L
