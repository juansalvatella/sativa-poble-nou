...
invokeTag('form','g',46,['name':("myForm"),'role':("form"),'class':("form-horizontal"),'url':([action:'search',controller:'member'])],1)
printHtmlPart(3)
...
printHtmlPart(10)
invokeTag('img','g',69,['dir':("css/img"),'file':("semaforoVerde.jpg")],-1)
printHtmlPart(11)
}
else if(true && (mem.status.name() == 'PARTNER_STATUS__DISABLED')) {
printHtmlPart(10)
invokeTag('img','g',72,['dir':("css/img"),'file':("semaforoAzul.jpg")],-1)
printHtmlPart(11)
}
else if(true && (mem.status.name() == 'PARTNER_STATUS__BANNED')) {
printHtmlPart(10)
invokeTag('img','g',75,['dir':("css/img"),'file':("semaforoRojo.jpg")],-1)
printHtmlPart(11)
}
else if(true && (mem.status.name() == 'PARTNER_STATUS__DETOXIFIED')) {
printHtmlPart(10)
invokeTag('img','g',78,['dir':("css/img"),'file':("semaforoNaranja.jpg")],-1)
printHtmlPart(11)
}
...
printHtmlPart(16)
invokeTag('render','g',115,['template':("/sativaTemplate/scriptsTemplate")],-1)
printHtmlPart(17)
}
...
public static final long LAST_MODIFIED = 1425331602000L
