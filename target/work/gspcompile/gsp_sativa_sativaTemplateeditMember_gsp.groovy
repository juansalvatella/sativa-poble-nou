...
printHtmlPart(30)
for( _it1952803446 in (listGenetics) ) {
changeItVariable(_it1952803446)
printHtmlPart(31)
...
printHtmlPart(37)
for( _it774939821 in (listEvents) ) {
changeItVariable(_it774939821)
printHtmlPart(38)
...
public static final long LAST_MODIFIED = 1431104789000L
